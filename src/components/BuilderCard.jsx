  ...
  return (
    <div className='grid gap-2'>
      <div className='flex items-center gap-6'>
        <h3 className='text-2xl font-semibold'>{component}</h3>
        <div className="w-full border-t-[1px] border-gray-500"></div>
      </div>
      {data ? 
      <div className='flex flex-col justify-between gap-1 lg:flex-row md:gap-4'>
      ...
      : 
      allowModification ? 
      <div className='grid justify-start py-3'>
